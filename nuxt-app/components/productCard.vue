<template>
    <div   class="flex flex-wrap max-w-44 md:max-w-52 lg:max-w-60 group transition-all duration-500 p-2 bg-gray-200 rounded-xl   items-center justify-items-center" >
...
<div class="mx-auto mt-5" ><button  @click="getData" class="font-extralight text-sm opacity-0 group-hover:opacity-100  animate__animated animate__pulse animate__infinite	 bg-rose-700 rounded-lg  mx-auto text-nowrap px-2 py-1 hover:tracking-tight duration-300 transition-all"  >سفارش این محصول</button></div>       
</div>
</template>
